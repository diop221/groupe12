# Script de présentation et de tournage — DVWA
...
## 01. Injection SQL classique
Module : /vulnerabilities/sqli/ • Sources : upstream/vulnerabilities/sqli/source/
...
## 02. Injection SQL aveugle
Module : /vulnerabilities/sqli_blind/ • Sources : upstream/vulnerabilities/sqli_blind/source/
...
## 03. Injection de commandes système
Module : /vulnerabilities/exec/ • Sources : upstream/vulnerabilities/exec/source/
...
## 04. XSS réfléchie
Module : /vulnerabilities/xss_r/ • Sources : upstream/vulnerabilities/xss_r/source/
...
## 05. XSS stockée
Module : /vulnerabilities/xss_s/ • Sources : upstream/vulnerabilities/xss_s/source/
...
## 06. XSS basée sur le DOM
Module : /vulnerabilities/xss_d/ • Sources : upstream/vulnerabilities/xss_d/source/
...
## 07. CSRF : modification non consentie
Module : /vulnerabilities/csrf/ • Sources : upstream/vulnerabilities/csrf/source/
...
## 08. Inclusion de fichiers et traversée
Module : /vulnerabilities/fi/ • Sources : upstream/vulnerabilities/fi/source/
...
## 09. Téléversement de fichier non sûr
Module : /vulnerabilities/upload/ • Sources : upstream/vulnerabilities/upload/source/
...
## 10. Contournement des autorisations
Module : /vulnerabilities/authbypass/ • Sources : upstream/vulnerabilities/authbypass/source/
...
## 11. Broken Access Control : confiance dans un cookie
Module : /vulnerabilities/bac/ • Sources : upstream/vulnerabilities/bac/source/
...
## 12. Force brute et limitation des tentatives
Module : /vulnerabilities/brute/ • Sources : upstream/vulnerabilities/brute/source/
...
## 13. Identifiants de session faibles
Module : /vulnerabilities/weak_id/ • Sources : upstream/vulnerabilities/weak_id/source/
...
## 14. CAPTCHA non sûr et saut d’étape
Module : /vulnerabilities/captcha/ • Sources : upstream/vulnerabilities/captcha/source/
...
## 15. Contournement de Content Security Policy
Module : /vulnerabilities/csp/ • Sources : upstream/vulnerabilities/csp/source/
...
## 16. Attaques JavaScript et confiance dans le client
Module : /vulnerabilities/javascript/ • Sources : upstream/vulnerabilities/javascript/source/
...
## 17. Redirection HTTP ouverte
Module : /vulnerabilities/open_redirect/ • Sources : upstream/vulnerabilities/open_redirect/source/
...
## 18. Cryptographie : XOR, ECB, oracle et intégrité
Module : /vulnerabilities/cryptography/ • Sources : upstream/vulnerabilities/cryptography/source/
...
## 19. Sécurité des API : quatre sous-exercices
Module : /vulnerabilities/api/ • Sources : upstream/vulnerabilities/api/source/
...
## Parcours systématique des niveaux intermédiaires
